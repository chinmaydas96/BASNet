...
#################### change here #################
############# give the directory where test data present ###########

data_name = 'TEST-DATA' # this will be drawn on the bottom center of the figures

########### change the directory to test data directory ##############

data_dir = './test_data/validation/' # set the data directory,
...
######################   change here #################
##########give the directory for ground truth value which is also present in test-data directory#

gt_dir = 'gt' # set the ground truth folder name
#gt_dir = 'test_results' # set the ground truth folder name

######## change here ##########
########## Put the prediction in output folder ##########
output_folder = 'output'
rs_dirs = [output_folder,'rs2'] # set the folder names of different methods
