...
tra_image_dir = 'new_03_05/train/Image/'
tra_label_dir = 'new_03_05/train/Mask/'

valid_image_dir = 'new_03_05/validation/Image/'
valid_label_dir = 'new_03_05/validation/Mask/'
...
PATH = "./saved_models/optimized_model_0.470269.pth"
...
valid_loader = DataLoader(val_data, batch_size=batch_size_val, shuffle=True, num_workers=0)
